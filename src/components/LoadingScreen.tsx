...
//  - Wings sweep left to (41.9, 131) and right to (458.1, 131)
//  - Left shoulder at (118.8, 106.8), right at (381.2, 106.8)
//  - Left ear tip at (166.8, 4), right at (333.2, 4)       ← highest points
//  - Center notch between ears at (250, 26.8)                ← V-dip between ears
//  - Fully symmetric around x=250
//
const BAT_D =
  'M 250.0,172.0 ' +
  'C 250.3,172.0 243.4,142.9 234.7,131.3 ' +
  'C 224.0,117.3 208.9,106.0 192.5,99.8 ' +
  'C 178.1,94.4 161.7,93.9 146.4,96.1 ' +
  'C 136.6,97.5 118.8,106.8 118.8,106.8 ' +
  'C 118.8,106.8 120.4,99.2 118.7,96.1 ' +
  'C 116.3,91.7 110.8,89.5 106.1,88.1 ' +
  'C 102.0,86.9 97.5,87.4 93.4,87.9 ' +
  'C 88.8,88.5 84.2,89.7 80.0,91.5 ' +
  'C 75.4,93.4 71.4,96.3 67.4,99.3 ' +
  'C 63.9,101.8 60.4,104.5 57.4,107.7 ' +
  'C 54.6,110.8 52.4,114.5 50.1,118.1 ' +
  'C 47.3,122.3 41.9,131.0 41.9,131.0 ' +
  'C 41.9,131.0 55.5,98.5 65.1,83.9 ' +
  'C 73.5,71.2 83.7,59.7 94.7,49.2 ' +
  'C 104.9,39.6 116.1,31.1 128.0,23.6 ' +
  'C 140.2,15.9 166.8,4.0 166.8,4.0 ' +
  'C 166.8,4.0 167.1,8.8 167.6,11.1 ' +
  'C 168.1,13.8 169.0,16.4 169.7,19.0 ' +
  'C 170.4,21.7 171.7,27.1 171.7,27.1 ' +
  'C 171.7,27.1 181.6,28.6 186.5,29.6 ' +
  'C 194.2,31.0 201.8,32.7 209.5,34.4 ' +
  'C 215.8,35.8 228.5,39.0 228.5,39.0 ' +
  'C 228.5,39.0 230.6,31.2 231.6,27.4 ' +
  'C 232.6,23.4 234.7,15.5 234.7,15.5 ' +
  'C 237.0,19.4 239.4,23.2 241.7,27.1 ' +
  'C 241.7,27.1 247.5,26.8 250.0,26.8 ' +
  'C 252.5,26.8 258.3,27.1 258.3,27.1 ' +
  'C 260.6,23.2 263.0,19.4 265.3,15.5 ' +
  'C 265.3,15.5 267.4,23.4 268.4,27.4 ' +
  'C 269.4,31.2 271.5,39.0 271.5,39.0 ' +
  'C 271.5,39.0 284.2,35.8 290.5,34.4 ' +
  'C 298.2,32.7 305.8,31.0 313.5,29.6 ' +
  'C 318.4,28.6 328.3,27.1 328.3,27.1 ' +
  'C 328.3,27.1 329.6,21.7 330.3,19.0 ' +
  'C 331.0,16.4 331.9,13.8 332.4,11.1 ' +
  'C 332.9,8.8 333.2,4.0 333.2,4.0 ' +
  'C 333.2,4.0 359.8,15.9 372.0,23.6 ' +
  'C 383.9,31.1 395.1,39.6 405.3,49.2 ' +
  'C 416.3,59.7 426.5,71.2 434.9,83.9 ' +
  'C 444.5,98.5 458.1,131.0 458.1,131.0 ' +
  'C 458.1,131.0 452.7,122.3 449.9,118.1 ' +
  'C 447.6,114.5 445.4,110.8 442.6,107.7 ' +
  'C 439.6,104.5 436.1,101.8 432.6,99.3 ' +
  'C 428.6,96.3 424.6,93.4 420.0,91.5 ' +
  'C 415.8,89.7 411.2,88.5 406.6,87.9 ' +
  'C 402.5,87.4 398.0,86.9 393.9,88.1 ' +
  'C 389.2,89.5 383.7,91.7 381.3,96.1 ' +
  'C 379.6,99.2 381.2,106.8 381.2,106.8 ' +
  'C 381.2,106.8 363.4,97.5 353.6,96.1 ' +
  'C 338.3,93.9 321.9,94.4 307.5,99.8 ' +
  'C 291.1,106.0 276.0,117.3 265.3,131.3 ' +
  'C 256.6,142.9 249.7,172.0 250.0,172.0 Z'      // back to bottom center
